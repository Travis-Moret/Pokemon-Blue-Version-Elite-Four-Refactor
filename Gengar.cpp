...
* Returns: nothing
*/
Gengar::Gengar() : Pokemon("Gengar",1,18,18,1)//set from Pokemon
{  
...
* Returns: totalAttack
*/
int Gengar::attackMove(Pokemon *defender)
{
   int count = 1;
   int totalAttack = 0;
   int rollValue = 0;
...
* Returns: nothing
*/
void Gengar::defendMove(int attack)
{
   int count = 1;
   int totalDefense = 0;
   int rollValue = 0;
   ...
   {  
      cout << endl;  
      cout << getName() << " Was not effected by the attack! " << endl; 
