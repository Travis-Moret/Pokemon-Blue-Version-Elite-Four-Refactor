...
* Returns: nothing
*/
Machamp::Machamp() : Pokemon("Machamp",1,18,18,1)//set from Pokemon
{  
   //set dice values for attack and defense
   attackerRoll.diceCount = 1;
   attackerRoll.diceSides = 15;
   defenderRoll.diceCount = 1;
   defenderRoll.diceSides = 10;
...
* Returns: totalAttack
*/
int Machamp::attackMove(Pokemon *defender)
{
   int count = 1;
   int totalAttack = 0;
   int rollValue = 0;
...
* Returns: nothing
*/
void Machamp::defendMove(int attack)
{
   int count = 1;
   int totalDefense = 0;
   int rollValue = 0;
   ...
   {  
      cout << endl;  
      cout << getName() << " charmed it's opponent! It's opponent " << 
              "did not attack!" << endl; 
