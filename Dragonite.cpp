...
* Returns: nothing
*/
Dragonite::Dragonite() : Pokemon("Dragonite",1,25,25,1)//set from Pokemon
{  
...
* Returns: totalAttack
*/
int Dragonite::attackMove(Pokemon *defender)
{
   int count = 1;
   int totalAttack = 0;
   int rollValue = 0;
...
* Returns: nothing
*/
void Dragonite::defendMove(int attack)
{
   int count = 1;
   int totalDefense = 0;
   int rollValue = 0;
   ...
   {  
      cout << endl;  
      cout << getName() << " Dodged it's opponent!" << endl;  
